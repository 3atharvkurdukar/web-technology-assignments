...
<body>
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="text-primary">Matrix Multiplication</h1>
				<hr>
			</div>
			<form action="" class="form-inline" method="post">
				...
				<div class="col-sm-8 offset-2">
					<button type="submit" class="btn btn-lg btn-block btn-primary" name="sbumit">Multiply</button>
				</div>
			</form>
			<div class="col-sm-12"><br></div>
			<?php
